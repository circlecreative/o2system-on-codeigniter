<html>
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="<?php echo o2system_url(); ?>assets/packages/bootstrap/bootstrap.min.css">

        <!-- Bootstrap Optional theme -->
        <link rel="stylesheet" href="<?php echo o2system_url(); ?>assets/packages/bootstrap/themes/default/default.min.css">
        <link rel="stylesheet" href="<?php echo o2system_url(); ?>assets/packages/pretiffy/pretiffy.css">

        <!-- Font Icon CSS -->
        <link rel="stylesheet" href="<?php echo o2system_url(); ?>assets/fonts/font-awesome/font-awesome.min.css">
    ...
    <!-- Include jQuery -->
    <script type="text/javascript" src="<?php echo o2system_url(); ?>assets/js/jquery.js"></script>

    <!-- Include Prettify JS -->
    <script type="text/javascript" src="<?php echo o2system_url(); ?>assets/packages/pretiffy/pretiffy.js"></script>

    <!-- Include Bootstrap -->
    <script src="<?php echo o2system_url(); ?>assets/packages/bootstrap/bootstrap.min.js"></script>
